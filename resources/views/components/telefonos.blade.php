                        ...
                        <tbody class="divide-y divide-slate-100">
                            @foreach($telefonos as $tel)
                                <tr class="text-slate-600 hover:bg-white transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="inline-flex items-center rounded-lg bg-slate-200/50 px-2 py-0.5 text-[10px] font-bold text-slate-600 ring-1 ring-slate-200">
                                            {{ $tel->tipo ?? '---' }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        @if($tel->yape)
                                            <span class="text-emerald-500 font-bold text-[11px]">Sí</span>
                                        @else
                                            <span class="text-slate-300 font-bold text-[11px]">No</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center justify-center gap-2">
                                            {{-- Botón WhatsApp --}}
                                            <a href="https://wa.me/51{{ $tel->telefono }}" target="_blank" 
                                               class="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-emerald-100 text-emerald-600 hover:bg-emerald-600 hover:text-white transition-all shadow-sm"
